...
exporter: exporter.cpp rapidjson/document.h rapidjson/writer.h rapidjson/stringbuffer.h
	g++ exporter.cpp rapidjson/document.h rapidjson/writer.h rapidjson/stringbuffer.h -Isrc -Wall -g
dist:
		cd ..; \
